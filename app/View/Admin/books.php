                ...
                <tr class="hover:bg-gray-50 transition">
                  <td class="px-6 py-4">
                    <?php if (!empty($book['cover'])): ?>
                      ...
                      >
                    <?php else: ?>
                      <div class="w-14 h-20 rounded-xl bg-gray-100 flex items-center justify-center text-xl">
                        📘
                      </div>
                    <?php endif; ?>
                  </td>
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center justify-end gap-3">
                      ...
                      >
                        <button class="bg-red-50 text-red-600 px-4 py-2 rounded-xl hover:bg-red-100 transition">
                          Hapus
                        </button>
                      </form>
            ...
            <?php else: ?>
              <tr>
                <td colspan="6" class="px-6 py-16 text-center">
                  ...
                  <a href="/admin/books/create" class="inline-block mt-5 bg-red-600 text-white px-5 py-3 rounded-xl">
                    + Tambah Buku
                  </a>
                </td>
              </tr>
