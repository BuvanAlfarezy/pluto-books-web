                ...
                <section class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <form action="/admin/books/store" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" required placeholder="Contoh: Atomic Habits"
                        ...
                        <div class="grid md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="category" placeholder="Filsafat, Sains, dll"
                                    class="w-full border border-gray-200 rounded-2xl px-5 py-4 outline-none focus:border-red-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="language" placeholder="Indonesia / English"
                                    class="w-full border border-gray-200 rounded-2xl px-5 py-4 outline-none focus:border-red-500">
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="content" rows="18" placeholder="Tulis isi buku di sini..."
                                class="w-full border border-gray-200 rounded-3xl px-5 py-5 outline-none focus:border-red-500 resize-none leading-relaxed"></textarea>
                        ...
                        <div>
                            ...
                            <label
                                ...
                                <!-- Preview -->
                                <img id="coverPreview" class="hidden w-full rounded-2xl shadow mb-5 object-cover">
                        ...
                        <div class="flex flex-wrap gap-4 pt-4">
                            ...
                            <button
                                class="bg-red-600 hover:bg-red-700 text-white px-7 py-4 rounded-2xl font-semibold transition shadow">
                                Simpan Buku
                            </button>

                            <a href="/admin/books"
                                class="bg-gray-100 hover:bg-gray-200 px-7 py-4 rounded-2xl font-medium transition">
                                Batal
                            </a>
