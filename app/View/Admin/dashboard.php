  ...
  <div class="flex h-screen">
   ...
   <aside class="hidden md:flex fixed left-0 top-0 h-screen w-72 bg-[#111] text-white flex-col justify-between p-6">
      <div>
        ...
        <nav class="space-y-3">
          <a href="/admin/dashboard" class="flex items-center gap-3 bg-white text-black px-4 py-3 rounded-xl font-medium">
            Dashboard
          </a>

          <a href="/admin/books" class="flex items-center gap-3 text-gray-300 hover:bg-white/10 px-4 py-3 rounded-xl transition">
            Kelola Buku
          </a>
        </nav>
      </div>
    ...
    <!-- Main Content -->
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="/admin/books/create" class="bg-red-600 text-white px-5 py-3 rounded-xl shadow hover:bg-red-700 transition">
            + Tambah Buku
          </a>
        </div>
      ...
      <section class="bg-[#111] text-white rounded-3xl p-8 md:p-10 mb-8 relative overflow-hidden">
        <div class="relative z-10 max-w-2xl">
          ...
          <a href="/admin/books" class="inline-block mt-7 bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition">
            Kelola Buku Sekarang
          </a>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div class="flex items-center justify-between">
            <div>
              ...
              <h4 class="text-4xl font-bold mt-2">0</h4>
            </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div class="flex items-center justify-between">
            <div>
              ...
              <h4 class="text-2xl font-bold mt-2 text-green-600">Aktif</h4>
            </div>
      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <a href="/admin/books" class="group bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition">
          <div class="flex items-start justify-between gap-4">
            <div>
              <div class="w-14 h-14 rounded-2xl bg-black text-white flex items-center justify-center text-2xl mb-5">
                📚
              </div>
        ...
        <a href="/admin/books/create" class="group bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition">
          <div class="flex items-start justify-between gap-4">
            <div>
              <div class="w-14 h-14 rounded-2xl bg-red-600 text-white flex items-center justify-center text-2xl mb-5">
                +
              </div>

              <h3 class="text-2xl font-bold">Tambah Buku</h3>
              <p class="text-gray-500 mt-2 leading-relaxed">
                Upload cover dan masukkan data buku baru.
              </p>
            </div>
