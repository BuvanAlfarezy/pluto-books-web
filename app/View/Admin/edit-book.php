                    ...
                    <form action="/admin/books/update/<?= $book['id']; ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <textarea name="content" rows="18"
                                class="w-full border border-gray-200 rounded-3xl px-5 py-5 outline-none focus:border-red-500 resize-none leading-relaxed"><?= htmlspecialchars($book['content']); ?></textarea>
                        ...
                        <div>
                            ...
                            <label
                                class="border-2 border-dashed border-gray-300 rounded-3xl p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-red-400 transition">
                ...
                <aside class="space-y-5">
                    ...
                    <div class="bg-[#111] text-white rounded-3xl p-6 overflow-hidden relative">
                        ...
                        <div class="relative z-10">
                            ...
                            <span
                                class="inline-block bg-yellow-500 text-black text-xs font-bold px-3 py-2 rounded-full mb-4">
                                EDIT MODE
                            </span>
